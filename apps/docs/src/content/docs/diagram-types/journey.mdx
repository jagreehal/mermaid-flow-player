...
<script type="module">
  ...
  const diagram = document.getElementById('journey-diagram');
...
<script type="module">
  ...
  const diagram = document.getElementById('journey');
  const player = createFlowPlayer({
    root: diagram,
    source: diagram.textContent,
    dim: 'others'
...
- [Flowcharts](../flowcharts/) | [Sequence](../sequence/) | [State](../state/) | [Gantt](../gantt/) | [Class](../class/) | [ER](../er/)
