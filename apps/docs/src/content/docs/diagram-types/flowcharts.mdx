...
Flowcharts are the most common diagram type. All features work seamlessly.
...
```html
<script type="module">
  import { createFlowPlayer, FlowchartBuilder } from 'https://cdn.jsdelivr.net/npm/mermaid-flow-player/index.js';
