...
<script type="module">
  ...
  const diagram = document.getElementById('gantt-diagram');
...
<script type="module">
  ...
  const diagram = document.getElementById('gantt');
  const player = createFlowPlayer({
    root: diagram,
    source: diagram.textContent,
    dim: 'others'
...
- [Flowcharts](../flowcharts/) | [Sequence](../sequence/) | [State](../state/) | [Journey](../journey/) | [Class](../class/) | [ER](../er/)
